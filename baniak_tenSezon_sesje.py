...
fig.update_layout(title_text='Ten Sezon BCU - Ilość Sesji', template="plotly_dark")
fig.write_html('/Users/przemyslaw.szafulski/Downloads/baniak_ten_sezon_sesje.html')